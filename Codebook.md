...
The following are measurements of the means and standard deviations extracted from the original data.
(For the TidyAverageData, this column is the mean of the measurements grouped by ActivityName and subjectId)
tBodyAcc-mean()-X
tBodyAcc-mean()-Y
tBodyAcc-mean()-Z
tBodyAcc-std()-X
